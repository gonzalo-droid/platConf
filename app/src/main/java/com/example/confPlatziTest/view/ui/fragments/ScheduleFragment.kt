...
import com.example.confPlatziTest.view.adapter.ScheduleListener
...
class ScheduleFragment : Fragment(), ScheduleListener {
    ...
    fun observeViewModel(){
        viewModel.listScheduleViewModel.observe(viewLifecycleOwner, Observer<List<Conference>> { schedule ->
    ...
    override fun onConferenceClicked(conference: Conference, position: Int) {
        val bundle = bundleOf("conferece" to conference)
